// 限价买单示例 (Limit Buy Order with Builder)
// 演示如何创建并提交限价买单,包括使用 Builder 配置进行订单归属
//
// 环境变量:
//   必需:
//     PK - 私钥
...
//
// 参数:
//   cargo run --example limit_buy_demo -- <TOKEN_ID> [PRICE] [SIZE]
//   例如: cargo run --example limit_buy_demo -- 123456 0.52 10.0
//
// 运行: cargo run --example limit_buy_demo
